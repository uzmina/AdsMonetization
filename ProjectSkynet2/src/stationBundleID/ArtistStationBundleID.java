...
class ArtistStationBundleID {
	...
	public void test() throws IOException {
		...
		String url = "https://clearchannel.deliveryengine.adswizz.com";
            	...
            	try {
                    ...
                    { 
                        ...
                        if(key1.contains(bundleId)) {
                        	...
                        	if(value1 != null) {
                        		//return true;
                        		System.out.println("bundle value is a pass   " + key1 + "\n"+ value1);
                        	}
                        		else {
                        			System.out.println("bundle id value is a fail   " +key1 + "\n" + value1);
                        		}
                        	}
                        }
