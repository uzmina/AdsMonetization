...
String fileName = "resources//testads.csv";
	...
	public void prerollLive() throws Exception{
	   ...
	   BufferedReader in = new BufferedReader(new FileReader(fileName));
	    ...
	    String liveStation1 = "genre=Prov_Beasley&provider=beasley";
	    String liveStation2 = "genre%3DACMAINSTREAM";
	    String station = "genre%3DCHRPOP";
	    ...
	    //List<String> filtered = matches.stream().filter(string -> !string.isEmpty()).collect(Collectors.toList());
