...
class sessionId {
	...
	public void test() throws IOException {
		...
		String sessionID = "aw_0_1st.sessionid";
        ...
        //match.stream().forEach(line -> System.out.println("custom ads calls  " + line));
        	...
        	try {
               ...
               // System.out.println("in for loop    "+map);
                ...
                { 
                    ...
                    if(key1.contains(sessionID)) {
                    	boolean value1 = entry.getValue() != null;
                    	//System.out.println(key1 +"\n" + value1);
                    	if(value1 == true) {
                    		//return true;
                    		System.out.println("session start value is a pass   "+ "\n" + key1 +"\n"+ value1);
                    	}
                    		else {
